...
and a P-P plot (i.e. for each value of the dataset, plot of the cumulative density function of the fitted distribution
...
As an example, let us look at the plot of the previous fit of a Weibull distribution to the \code{groundbeef} dataset
...
on a same dataset, using one of the four plots
...
Weibull, lognormal and gamma distributions to \code{groundbeef} dataset.
