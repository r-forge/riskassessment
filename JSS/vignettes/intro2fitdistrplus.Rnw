...
%%%%%%%%%%%%%%%%%%%%%% JE NE COMPRENDS PAS POURQUOI CETTE FIGURE NE SORT PAS A LA MEME TAILLE QUE LA FIGURE 1
...
such data is based upon maximum likelihood (see e.g. \cite{kleinmoeschberger03,helsel05}). 
