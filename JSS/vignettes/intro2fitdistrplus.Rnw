...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection[Choice of distributions]{Choice of candidate distributions}
\label{Choice}
...
%%%%%%%%%%%%% Je n'ai bouge que le premier que j'ai allege. Pour le deuxieme ca me parait plus complique
