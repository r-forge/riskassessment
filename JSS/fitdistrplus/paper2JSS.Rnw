...
deal with censored data, especially survival data \citep{survival,hiranoetal94,jordan05},
...
For moments of order greater than or equal to 2, it may  also be relevant to match centered moments as
...
In this numerical experiment,  the lognormal distribution is first considered and then the Pareto type II 
...
for computing the empirical raw moment (called \code{memp} in our example) has to be passed to \code{fitdist} , 
...
for simple MLE fits \citep{distrModJSS,jaloustreetal11,saketal11,kochetal12,marquetouxetal12,nordan12,
scholletal12,suuronenetal12,varoetal12,mandletal13}, for MLE fits and goodness-of-fit statistics 
\citep{garcia12,tarnczi11,bagariaetal12,benavidesetal12,breitbach12,poduje12,Pouillot10}, 
for MLE fits 
and bootstrap \citep{croucheretal12,meheustetal12,orellanoetal12,telloetal12,hoelzeretal12}, 
for MLE fits, 
bootstrap and goodness-of-fit statistics \citep{rebuge12}, 
for MME fit \citep{luangkesornetal12}, 
for 
censored MLE and bootstrap \citep{lehaetal11,poulliotetal12,jongenburgeretal12,commeauetal12,pouillotetal11}, 
for graphic analysing in \citep{anandetal12,rosa12}, 
for grouped-data fitting methods \citep{fusteinercostafreda12} 
or more generally \citep{eling12,busschaertetal10,brooksetal11,aktassjostrand11,eikhermann12,bakos11}.
