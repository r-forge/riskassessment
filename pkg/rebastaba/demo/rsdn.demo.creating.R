...
# 
# 10_02_12 10_02_15 10_03_09 10_04_16 10_06_23
# 
#
#
...
############################################################
form3titre("Simulating with a /bn/ comprising a 'parcat' node");

form3titre("Generating the /dn/ named dd",0);

if (!exists("chemin")) {
    cat("A file into the private 'files' directory is needed\n");
    erreur("The package must be installed to run this demo");
}
fifi <- "rsdn.demo.bn.parcat.txt";
