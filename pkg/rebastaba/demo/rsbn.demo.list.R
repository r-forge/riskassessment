...
#
# the basics
print(list2bn(bn2list(rebastaba.bn0)));
print(list2bn(bn2list(rebastaba.bn1)));
print(list2bn(bn2list(rebastaba.bn2)));
print(list2bn(bn2list(rebastaba.bn3)));
print(list2bn(bn2list(rebastaba.bn4)));
print(list2bn(bn2list(rebastaba.bn5)));
print(list2bn(bn2list(rebastaba.bn6)));
