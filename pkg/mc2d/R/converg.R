...
#[INPUTS]
#{node}<<The node to be considered in a mc object or a mccut object, displayed either as the order number or the name of the node.
#By default: the last node of the object.The corresponding node should not be of type "0" in a mc object or 
#of type "0" or "V" in a mccut object.>>
...
#{iter}<<If margin == "var" and the node is a "VU" mcnode, iter specify
...
#NOTE
#This function may be used on a mccut object only if a summary.mc function was used in the third block of the \code{\link{evalmccut}} call.
#The values used as probs arguments in converg should have been used in the summary.mc function of this third block.
#DETAILS
#If the node is of type "V", the running mean, median and probs
#quantiles according to the variability dimension will be provided. If the node is of type "VU" and margin=="var",
#this graph will be provided on one simulation in the uncertainty dimension (chosen by iter).</>
...
#If the node is of type "VU" (with margin=="unc" or from a mccut object),
#one graph are provided for each of the mean, median and probs quantiles calculated in the variability dimension.
#EXAMPLE
#data(total)
